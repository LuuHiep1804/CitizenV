...
import {addPerson, getPersonByDistrictId, getPersonById, getPersonByName, getPersonByProvinceId, getPersonByRGroupId, getPersonByWardId, updatePerson} from '../controllers/person.js';
...
router.post('/by-name', getPersonByName);
